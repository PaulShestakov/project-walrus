...
import {fetchBreed} from "../PromosList/actionCreators/promosList";
...
import LostPromo from '../../../containers/promos/NewPromo/types/LostPromo.jsx';
import FoundPromo from '../../../containers/promos/NewPromo/types/FoundPromo.jsx';
import BuyOrSellPromo from '../../../containers/promos/NewPromo/types/BuyOrSellPromo.jsx';
import GiveOrAcceptGiftPromo from '../../../containers/promos/NewPromo/types/GiveOrAcceptGiftPromo.jsx';
...
@withStyles(styles)
class NewPromoContainer extends React.Component {
	constructor(props) {
		super(props);
								...
								<Grid md={12} spacing={24} container direction="column" className="m-0">
									...
									<Grid item md={12} className="mb-1">
										<Grid container justify="center">
											<Grid item>
												<Button type="submit" className="my-1 text-white" accent="blue">
													{t('PUBLISH')}
												</Button>
											</Grid>
										</Grid>
